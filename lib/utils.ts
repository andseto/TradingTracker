...
// Supabase's PostgrestError/AuthError/StorageError are plain objects with a
// `.message`, not real Error instances — `instanceof Error` misses them and
// silently falls back to a useless generic string. Check both shapes.
